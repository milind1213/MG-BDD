...
test.describe.serial('Groceries API Test Suite', () => {
  ...
  test('Verify server status is up', async ({ request }) => {
    const response = await request.get(`${config.BASE_URL_2}/status`);
  ...
  test('Generate access token', async ({ request }) => {
    ...
    const response = await request.post(`${config.BASE_URL_2}/api-clients`, { data: payload });
    const body = await response.json();
  ...
  test('Fetch product by ID', async ({ request }) => {
    const response = await request.get(`${config.BASE_URL_2}/products/4643`);
    const body = await response.json();
  ...
  test('Fetch all products', async ({ request }) => {
    const response = await request.get(`${config.BASE_URL_2}/products/`);
  ...
  test('Create a new cart', async ({ request }) => {
    const response = await request.post(`${config.BASE_URL_2}/carts/`);
    const body = await response.json();
  ...
  test('Add item to cart', async ({ request }) => {
    ...
    const response = await request.post(`${config.BASE_URL_2}/carts/${cartId}/items`, { data: payload });
    const body = await response.json();
  ...
  test('Update cart item quantity', async ({ request }) => {
    ...
    const response = await request.patch(`${config.BASE_URL_2}/carts/${cartId}/items/${itemId}`, { data: payload });
  ...
  test('Create order', async ({ request }) => {
    ...
    const response = await request.post(`${config.BASE_URL_2}/orders/`, {
  ...
  test('Fetch all orders', async ({ request }) => {
    ...
    const response = await request.get(`${config.BASE_URL_2}/orders/`, {
      headers: { Authorization: `Bearer ${accessToken}` },
    });
    const body = await response.json();
  ...
  test('Update order customer name', async ({ request }) => {
    ...
    const response = await request.patch(`${config.BASE_URL_2}/orders/${orderId}`, {
      headers: { Authorization: `Bearer ${accessToken}` },
      data: payload,
    });
  ...
  test('Delete order', async ({ request }) => {
    ...
    const response = await request.delete(`${config.BASE_URL_2}/orders/${orderId}`, {
      headers: { Authorization: `Bearer ${accessToken}` },
    });

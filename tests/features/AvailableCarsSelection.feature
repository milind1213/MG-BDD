...
Feature: Shopping for Cars and Selecting the Available Car Model
 ...
 Scenario Outline: Verify 'Sort By' filters functiionality
     ...
     Then I verify the default sort "Quickest delivery" filter applied
      And I Apply Price "<SortFilter>" Filter the the Cars Dispaly should be "<DisplayOrder>" Sorted order 
   Examples:
 ...
 Scenario Outline: Verify Car Filters with Various Combinations of Selections
    ...
    # Case 1: Select all options for exterior, version, packs, options, interior, and wheels
       | Exterior  | Version               | Packs       | Options                     | Interior                | Wheels           |
       | Snow      | Long range Dual motor | Performance | Harman Kardon premium sound | Charcoal Nappa leather  | 20" Performance  |
       | Space     | Long range Dual motor | Climate     | Harman Kardon premium sound | Zinc Nappa leather      | 20" Performance  |
  ...
  #   When I select "Clear All Filter
